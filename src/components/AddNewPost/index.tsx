...
import { UserState } from '../../redux/user/userSlice.ts';
import { useDispatch } from 'react-redux';
import { createOrUpdatePost } from '../../redux/post/postSlice.ts';

import { UserAvatarCircle } from "../index.ts"
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(
        createOrUpdatePost({
            ...
            likes: generateRandomNumberBetween(1, 100),
